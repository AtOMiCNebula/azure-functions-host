...
namespace Microsoft.Azure.WebJobs.Script.Scale
{
    ...
    public interface IScaleMetricsRepository
    {
        ...
        Task WriteAsync(IDictionary<IScaleMonitor, ScaleMetrics> monitorMetrics);
        ...
        Task<IDictionary<IScaleMonitor, IList<ScaleMetrics>>> ReadAsync(IEnumerable<IScaleMonitor> monitors);
    }
}
